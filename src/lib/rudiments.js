...
export const RUDIMENTS = [
  ...
  { id: 11, cat: "roll", label: "11. Ten Stroke Roll", bars: 1, time: "4/4", notes: [...trip(0, "RLR", [0]), ...trip(1, "LRL", [2]), ...trip(2, "RLR", [0]), ...trip(3, "LRL", [2])], sticking: dual("RLRLRLRLRLRL") },
  { id: 12, cat: "roll", label: "12. Eleven Stroke Roll", bars: 1, time: "4/4", notes: [...trip(0, "RLR", [0]), ...trip(1, "LRL", [2]), ...trip(2, "RLR", [0]), ...trip(3, "LRL", [])], sticking: dual("RLRLRLRLRLRL") },
