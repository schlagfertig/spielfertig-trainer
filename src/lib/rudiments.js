...
export const RUDIMENTS = [
  ...
  { id: 25, cat: "flam", label: "25. Single Flammed Mill", bars: 1, time: "2/4", notes: [n(0, 1, "R", true, { flam: "L", g: 1 }), n(1, 1, "R", false, { g: 1 }), n(2, 1, "L", false, { g: 1 }), n(3, 1, "R", false, { g: 1 }), n(4, 1, "L", true, { flam: "R", g: 2 }), n(5, 1, "L", false, { g: 2 }), n(6, 1, "R", false, { g: 2 }), n(7, 1, "L", false, { g: 2 })], sticking: dual("RRLRLLRL") },
  ...
  { id: 37, cat: "drag", label: "37. Drag Paradiddle #2", bars: 1, time: "4/4", notes: [...dp2(0, "R", 1), ...dp2(8, "L", 2)], sticking: dualTok(["R", "LLR", "LLR", "L", "R", "R", "L", "RRL", "RRL", "R", "L", "L"]) },
