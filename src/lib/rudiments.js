...
export const RUDIMENTS = [
  ...
  { id: 17, cat: "diddle", label: "17. Double Paradiddle", bars: 1, time: "3/4", notes: [...run(0, "RLRLRR", 1, [0], { g: 1 }), ...run(6, "LRLRLL", 1, [0], { g: 2 })], sticking: ["RLRLRRLRLRLL"] },
  { id: 18, cat: "diddle", label: "18. Triple Paradiddle", bars: 1, time: "4/4", notes: [...run(0, "RLRLRLRR", 1, [0], { g: 1 }), ...run(8, "LRLRLLRR", 1, [0], { g: 2 })], sticking: ["RLRLRLRRLRLRLLRR"] },
  { id: 19, cat: "diddle", label: "19. Paradiddle-Diddle", bars: 1, time: "3/4", notes: [...run(0, "RLRRLL", 1, [0], { g: 1 }), ...run(6, "LRLRRL", 1, [0], { g: 2 })], sticking: ["RLRRLLLRLRRL"] },
