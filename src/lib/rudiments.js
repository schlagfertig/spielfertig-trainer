...
const sixStroke = (start, g, lead = "R") => {
  const a = lead;
  const b = lead === "R" ? "L" : "R";
  return [
    n(start, 2, a, true, { g, beams: 1 }),
    n(start + 2, 1, b, false, { g, beams: 2 }),
    n(start + 3, 1, b, false, { g, beams: 2 }),
    n(start + 4, 1, a, false, { g, beams: 2 }),
    n(start + 5, 1, a, false, { g, beams: 2 }),
    n(start + 6, 2, b, true, { g, beams: 1 }),
  ];
};
...
export const RUDIMENTS = [
  ...
  { id: 8, cat: "roll", label: "8. Six Stroke Roll", bars: 1, time: "4/4", notes: [...sixStroke(0, 1, "R"), ...sixStroke(8, 2, "L")], sticking: dual("RLLRRLRLRRLL") },
  { id: 9, cat: "roll", label: "9. Seven Stroke Roll", bars: 1, time: "4/4", notes: [n(0, 2, "L", false, { roll: 3, tie: true }), n(2, 2, "R", true), rest(4, 4), n(8, 2, "R", false, { roll: 3, tie: true }), n(10, 2, "L", true), rest(12, 4)], sticking: dualTok(["LLRRLL", "R", "RRLLRR", "L"]) },
  { id: 10, cat: "roll", label: "10. Nine Stroke Roll", bars: 1, time: "4/4", notes: [n(0, 2, "R", false, { roll: 3, tie: true }), n(2, 2, "R", true), n(4, 2, "L", false, { roll: 3, tie: true }), n(6, 2, "L", true), n(8, 2, "R", false, { roll: 3, tie: true }), n(10, 2, "R", true), n(12, 2, "L", false, { roll: 3, tie: true }), n(14, 2, "L", true)], sticking: dualTok(["RRLLRRLL", "R", "LLRRLLRR", "L", "RRLLRRLL", "R", "LLRRLLRR", "L"]) },
  { id: 11, cat: "roll", label: "11. Ten Stroke Roll", bars: 1, time: "4/4", notes: [n(0, 2, "R", false, { roll: 3, tie: true }), n(2, 1, "R", true, { g: 1 }), n(3, 1, "L", true, { g: 1 }), rest(4, 4), n(8, 2, "L", false, { roll: 3, tie: true }), n(10, 1, "L", true, { g: 2 }), n(11, 1, "R", true, { g: 2 }), rest(12, 4)], sticking: dualTok(["RRLLRRLLR", "R", "L", "LLRRLLRRL", "L", "R"]) },
  { id: 12, cat: "roll", label: "12. Eleven Stroke Roll", bars: 1, time: "4/4", notes: [n(0, 2, "R", false, { roll: 3, tie: true }), n(2, 1, "R"), n(3, 1, "L", true), rest(4, 4), n(8, 2, "L", false, { roll: 3, tie: true }), n(10, 1, "L"), n(11, 1, "R", true), rest(12, 4)], sticking: dualTok(["RRLLRRLLRR", "R", "L", "LLRRLLRRLL", "L", "R"]) },
  { id: 13, cat: "roll", label: "13. Thirteen Stroke Roll", bars: 1, time: "4/4", notes: [n(0, 6, "R", false, { roll: 3, tie: true }), n(6, 2, "R", true), n(8, 6, "L", false, { roll: 3, tie: true }), n(14, 2, "L", true)], sticking: dualTok(["RRLLRRLLRRLL", "R", "LLRRLLRRLLRR", "L"]) },
  { id: 14, cat: "roll", label: "14. Fifteen Stroke Roll", bars: 1, time: "4/4", notes: [n(0, 6, "R", false, { roll: 3, tie: true }), n(6, 1, "R"), n(7, 1, "L", true), rest(8, 8)], sticking: dualTok(["RRLLRRLLRRLLRR", "R", "L"]) },
  { id: 15, cat: "roll", label: "15. Seventeen Stroke Roll", bars: 1, time: "4/4", notes: [n(0, 8, "R", false, { roll: 3, tie: true }), n(8, 4, "R", true), rest(12, 4)], sticking: dualTok(["RRLLRRLLRRLLRRLL", "R"]) },
